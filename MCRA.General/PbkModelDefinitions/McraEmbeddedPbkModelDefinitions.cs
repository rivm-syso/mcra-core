...
namespace MCRA.General {
    ...
    public class McraEmbeddedPbkModelDefinitions {
        ...
        private static IDictionary<string, EmbeddedPbkModelSpecification> _pbkModelDefinitions;

        /// <summary>
        /// Returns all module definitions.
        /// </summary>
        public static IDictionary<string, EmbeddedPbkModelSpecification> Definitions {
            get {
        ...
        /// <returns></returns>
        public static bool TryGetDefinitionByAlias(string str, out EmbeddedPbkModelSpecification definition) {
        ...
        /// </summary>
        private static Collection<EmbeddedPbkModelSpecification> loadDefinitions() {
            ...
            using (var stream = assembly.GetManifestResourceStream("MCRA.General.PbkModelDefinitions.EmbeddedPbkModelSpecifications.Generated.xml")) {
                var xs = new XmlSerializer(typeof(EmbdeddedPbkModelSpecificationCollection));
                var definitions = (EmbdeddedPbkModelSpecificationCollection)xs.Deserialize(stream);
                return definitions;
            }
        }
    }
