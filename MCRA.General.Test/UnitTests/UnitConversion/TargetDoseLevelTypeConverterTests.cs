...
namespace MCRA.General.Test.UnitTests.UnitConversion {
    ...
    [TestClass]
    public class TargetDoseLevelTypeConverterTests {

        [TestMethod]
        public void TargetDoseLevelTypeConverterTests_TestCompleteness() {
        ...
        /// </summary>
        [TestMethod]
        public void TargetDoseLevelTypeConverterTests_TestAliases() {
            var definition = TargetLevelTypeConverter.UnitDefinition;
        ...
        /// </summary>
        [TestMethod]
        public void TargetDoseLevelTypeConverterTests_TestDisplayNames() {
            var definition = TargetLevelTypeConverter.UnitDefinition;
            foreach (var units in definition.Units) {
