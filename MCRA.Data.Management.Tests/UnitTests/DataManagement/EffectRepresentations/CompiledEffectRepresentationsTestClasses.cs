...
namespace MCRA.Data.Management.Test.UnitTests.DataManagement {
    ...
    /// </summary>
    [TestClass]
    public class CompiledDataManagerEffectRepresentationsTests : CompiledEffectRepresentationsTests {
        [TestInitialize]
        public override void TestInitialize() {
            base.TestInitialize();
            _getItemsDelegate = () => _compiledDataManager.GetAllEffectRepresentations();
        }
    }
    ...
    /// </summary>
    [TestClass]
    public class SubsetManagerEffectRepresentationsTests : CompiledEffectRepresentationsTests {
        ...
        public override void TestInitialize() {
            ...
            _getItemsDelegate = () => _subsetManager.AllEffectRepresentations.SelectMany(r => r).ToList();
        }
    }
}
