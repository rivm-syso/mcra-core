...
namespace MCRA.Data.Management.Test.UnitTests.DataManagement {
    ...
    /// </summary>
    [TestClass]
    public class CompiledDataManagerConcentrationLimitsTests: CompiledConcentrationLimitsTests {
        [TestInitialize]
        public override void TestInitialize() {
            base.TestInitialize();
            _getItemsDelegate = () => _compiledDataManager.GetAllMaximumConcentrationLimits();
        }
    }
    ...
    /// </summary>
    [TestClass]
    public class SubsetManagerConcentrationLimitsTests : CompiledConcentrationLimitsTests {
        ...
        public override void TestInitialize() {
            ...
            _getItemsDelegate = () => _subsetManager.AllMaximumConcentrationLimits;
        }
    }
}
