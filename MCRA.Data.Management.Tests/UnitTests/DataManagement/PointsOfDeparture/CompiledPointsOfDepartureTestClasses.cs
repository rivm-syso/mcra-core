...
namespace MCRA.Data.Management.Test.UnitTests.DataManagement {
    ...
    /// </summary>
    [TestClass]
    public class CompiledPointsOfDepartureTestCompiledDataManager : CompiledPointsOfDepartureTests {
        [TestInitialize]
        public override void TestInitialize() {
            base.TestInitialize();
            _getItemsDelegate = () => _compiledDataManager.GetAllPointsOfDeparture();
        }
    }
    ...
    /// </summary>
    [TestClass]
    public class SubsetManagerAllPointsOfDepartureTests : CompiledPointsOfDepartureTests {
        ...
        public override void TestInitialize() {
            ...
            _getItemsDelegate = () => _subsetManager.AllPointsOfDeparture;
        }
    }
}
