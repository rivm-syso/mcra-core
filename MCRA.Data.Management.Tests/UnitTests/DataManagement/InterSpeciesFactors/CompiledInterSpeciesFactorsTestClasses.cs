namespace MCRA.Data.Management.Test.UnitTests.DataManagement {
    ...
    /// </summary>
    [TestClass]
    public class CompiledDataManagerInterSpeciesFactorsTests: CompiledInterSpeciesFactorsTests {
        [TestInitialize]
        public override void TestInitialize() {
            base.TestInitialize();
            _getItemsDelegate = () => _compiledDataManager.GetAllInterSpeciesFactors();
        }
    }
    ...
    /// </summary>
    [TestClass]
    public class SubsetManagerInterSpeciesFactorsTests : CompiledInterSpeciesFactorsTests {
        ...
        public override void TestInitialize() {
            ...
            _getItemsDelegate = () => _subsetManager.AllInterSpeciesFactors;
        }
    }
}
