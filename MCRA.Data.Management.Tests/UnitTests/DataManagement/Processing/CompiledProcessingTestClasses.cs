...
namespace MCRA.Data.Management.Test.UnitTests.DataManagement {
    ...
    /// </summary>
    [TestClass]
    public class CompiledDataManagerProcessingTests: CompiledProcessingTests {
        [TestInitialize]
        public override void TestInitialize() {
            base.TestInitialize();
            _getItemsDelegate = () => _compiledDataManager.GetAllProcessingFactors();
        }
    }
    ...
    /// </summary>
    [TestClass]
    public class SubsetManagerProcessingTests : CompiledProcessingTests {
        ...
        public override void TestInitialize() {
            ...
            _getItemsDelegate = () => _subsetManager.AllProcessingFactors.ToList();
        }
    }
}
