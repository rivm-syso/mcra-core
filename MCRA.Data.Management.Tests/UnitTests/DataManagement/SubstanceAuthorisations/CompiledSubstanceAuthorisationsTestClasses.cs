...
namespace MCRA.Data.Management.Test.UnitTests.DataManagement {
    ...
    /// </summary>
    [TestClass]
    public class CompiledDataManagerSubstanceAuthorisationsTests : CompiledSubstanceAuthorisationsTests {
        [TestInitialize]
        public override void TestInitialize() {
            base.TestInitialize();
            _getItemsDelegate = () => _compiledDataManager.GetAllSubstanceAuthorisations();
        }
    }
    ...
    /// </summary>
    [TestClass]
    public class SubsetManagerSubstanceAuthorisationsTests : CompiledSubstanceAuthorisationsTests {
        ...
        public override void TestInitialize() {
            ...
            _getItemsDelegate = () => _subsetManager.AllSubstanceAuthorisations;
        }
    }
}
