    ...
    public class CompiledDataManagerZipFileTests {
        ...
        private static CompiledData createShallowCompiledDataInstance() {
            ...
            var data = new CompiledData {
                ...
                AllBurdensOfDisease = new List<BurdenOfDisease> { { new BurdenOfDisease() } },
                ...
                AllExposureResponseFunctions = new List<ExposureResponseFunction> { { new ExposureResponseFunction() } },
        ...
        private static CompiledData createBasicCompiledDataInstance() {
            var data = new CompiledData {
                ...
                AllConsumerProductSurveys = new Dictionary<string, ConsumerProductSurvey>(),
                AllIndividualConsumerProductUseFrequencies = [],
                ...
                AllIndividualSets = new Dictionary<string, IndividualSet>(),
                AllIndividualSetIndividuals = new Dictionary<string, Individual>(),
                AllIndividualSetIndividualProperties = new Dictionary<string, IndividualProperty>(),
