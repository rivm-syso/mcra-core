...
namespace MCRA.Simulation.Test.UnitTests.UnitVariabilityCalculation {
    ...
    /// </summary>
    [TestClass]
    public class NoUnitVariabilityModelTests {

        /// <summary>
        /// Test No variability model. Generates a model using and draws
        /// a number of times from this model.
        /// </summary>
        [TestMethod]
       // [TestCategory("Sandbox Tests")]
        public void NoUnitVariabilityModelTest1() {
            ...
            var uvCalculator = new NoUnitVariabilityModel(food, uvFactor);
