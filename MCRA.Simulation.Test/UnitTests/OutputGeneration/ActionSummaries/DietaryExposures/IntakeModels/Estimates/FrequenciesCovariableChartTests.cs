...
namespace MCRA.Simulation.Test.UnitTests.OutputGeneration.ActionSummaries.DietaryExposures {
    ...
    public class FrequenciesCovariableChartTests : ChartCreatorTestBase {
        ...
        public void FrequenciesCovariableChart_Test2() {
            ...
            xyCollectorConditional.Add(new ConditionalPrediction() { Prediction = .5, Cofactor = "male", Covariable = 7 });
            xyCollectorConditional.Add(new ConditionalPrediction() { Prediction = .6, Cofactor = "male", Covariable = 8 });
            xyCollectorConditional.Add(new ConditionalPrediction() { Prediction = .12, Cofactor = "male", Covariable = 9 });
            xyCollectorConditional.Add(new ConditionalPrediction() { Prediction = .13, Cofactor = "male", Covariable = 10 });
            xyCollectorConditional.Add(new ConditionalPrediction() { Prediction = .14, Cofactor = "male", Covariable = 11 });
            xyCollectorConditional.Add(new ConditionalPrediction() { Prediction = .15, Cofactor = "male", Covariable = 12 });
            xyCollectorConditional.Add(new ConditionalPrediction() { Prediction = .16, Cofactor = "male", Covariable = 13 });
            ...
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .2, Cofactor = "male", Covariable = 7 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .7, Cofactor = "male", Covariable = 8 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .10, Cofactor = "male", Covariable = 2 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .14, Cofactor = "male", Covariable = 3 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .15, Cofactor = "male", Covariable = 4 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .13, Cofactor = "male", Covariable = 5 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .18, Cofactor = "male", Covariable = 6 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .3, Cofactor = "male", Covariable = 4 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .8, Cofactor = "male", Covariable = 5 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .1, Cofactor = "male", Covariable = 6 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .11, Cofactor = "male", Covariable = 7 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .4, Cofactor = "male", Covariable = 8 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .17, Cofactor = "male", Covariable = 2 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .19, Cofactor = "male", Covariable = 3 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .10, Cofactor = "male", Covariable = 4 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .14, Cofactor = "male", Covariable = 5 });
            xyCollectorConditionalData.Add(new ConditionalPrediction() { Prediction = .11, Cofactor = "male", Covariable = 6 });
