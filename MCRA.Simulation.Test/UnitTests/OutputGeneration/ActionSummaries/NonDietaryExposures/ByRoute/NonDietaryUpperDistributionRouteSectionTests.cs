    ...
    public class NonDietaryUpperDistributionRouteSectionTests : SectionTestBase {
        ...
        public void NonDietaryUpperDistributionRouteSection_TestAcute() {
            ...
            for (int numIndividuals = 0; numIndividuals < 100; numIndividuals += 10) {
                ...
                section.SummarizeUncertainty(nonDietaryIntakes, rpfs, memberships, nonDietaryExposureRoutes, ExposureType.Acute, false);

                Assert.AreEqual(nonDietaryIntakes.Any() ? nonDietaryExposureRoutes.Count : 0, section.NonDietaryUpperDistributionRouteRecords.Count);
