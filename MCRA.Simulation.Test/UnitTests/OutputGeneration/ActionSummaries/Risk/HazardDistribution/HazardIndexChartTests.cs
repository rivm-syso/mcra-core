...
namespace MCRA.Simulation.Test.UnitTests.OutputGeneration.ActionSummaries.Risk {
    ...
    /// </summary>
    [TestClass]
    public class HazardIndexChartTests : ChartCreatorTestBase {
        /// <summary>
        /// Create chart
        /// </summary>
        [TestMethod]
        public void HazardIndexDistributionChart_Test1() {
            var number = 5000;
            ...
            var section = new HazardIndexDistributionSection() {
                HIDistributionBins = bins,
                PercentageZeros = 10,
            };

            var chart = new HazardIndexChartCreator(section);
