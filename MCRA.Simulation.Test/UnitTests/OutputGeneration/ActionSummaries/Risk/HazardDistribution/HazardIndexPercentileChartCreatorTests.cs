...
namespace MCRA.Simulation.Test.UnitTests.OutputGeneration.ActionSummaries.Risk {
    ...
    /// </summary>
    [TestClass]
    public class HazardIndexPercentileChartCreatorTests : ChartCreatorTestBase {

        /// <summary>
        /// Create chart with uncertainty
        /// </summary>
        [TestMethod]
        public void HIPercentileChart_TestUncertainty() {
            var section = new HazardIndexPercentileSection() {
                Percentiles = mock(100),
            };
            var chart = new HazardIndexPercentileChartCreator(section);
