...
namespace MCRA.Simulation.Test.Mock.MockDataGenerators {
    ...
    public static class MockAggregateIndividualDayIntakeGenerator {
        ...
        public static List<AggregateIndividualDayExposure> Create(
            ...
            var dietaryIndividualDayIntakes = MockDietaryIndividualDayIntakeGenerator.Create(simulatedIndividualDays, foods, substances, 0.5, true, random);
            var nonDietaryExposureRoutes = exposureRoutes.Where(r => r != ExposureRouteType.Dietary).ToList();
            var nonDietaryIndividualDayIntakes = MockNonDietaryIndividualDayIntakeGenerator.Generate(simulatedIndividualDays, substances, nonDietaryExposureRoutes, 0.5, random);
