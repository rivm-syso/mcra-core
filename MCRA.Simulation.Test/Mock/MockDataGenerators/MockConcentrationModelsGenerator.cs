...
namespace MCRA.Simulation.Test.Mock.MockDataGenerators {
    ...
    /// </summary>
    public static class MockConcentrationsModelsGenerator {
        ...
        private static CompoundResidueCollection createConcentrations(Food food, Compound compound, List<double> concentrations, double lor) {
            ...
            return new CompoundResidueCollection() {
                ...
                CensoredValuesCollection = concentrations.Where(r => r < lor).Select(r => new CensoredValueCollection() { LOD = lor, LOQ = lor, ResType = ResType.LOD }).ToList(),
