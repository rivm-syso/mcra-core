...
namespace MCRA.Data.Management {
    public interface ICompiledDataManager {
        ...
        IList<AirConcentrationDistribution> GetAllIndoorAirConcentrationDistributions();
        IList<AirConcentrationDistribution> GetAllOutdoorAirConcentrationDistributions();
