...
namespace MCRA.Utils.Test.UnitTests.DataSourceReading.DataReaders {
    ...
    [TestClass]
    public class CheckedDataTableReaderTests {

        [TestMethod]
        public void CheckedDataTableReader_TestFieldTypes() {
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestReadDataTable() {
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestReadBoolean() {
            var tableDef = FakeTableDefinition();
            var csvFilePath = @"Resources/CsvReaderTests/Test.csv";
            using (var reader = new StreamReader(csvFilePath)) {
                var stream = reader.BaseStream;
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestReadDateTime() {
            var tableDef = FakeTableDefinition();
            var csvFilePath = @"Resources/CsvReaderTests/Test.csv";
            using (var reader = new StreamReader(csvFilePath)) {
                var stream = reader.BaseStream;
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestFailReadDateTime() {
            var tableDef = FakeTableDefinition();
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestReadAlphaNumeric() {
            var tableDef = FakeTableDefinition();
            var csvFilePath = @"Resources/CsvReaderTests/Test.csv";
            using (var reader = new StreamReader(csvFilePath)) {
                var stream = reader.BaseStream;
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestReadNumeric() {
            var tableDef = FakeTableDefinition();
            var csvFilePath = @"Resources/CsvReaderTests/Test.csv";
            using (var reader = new StreamReader(csvFilePath)) {
                var stream = reader.BaseStream;
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestFailReadNumeric() {
            var tableDef = FakeTableDefinition();
            var csvFilePath = @"Resources/CsvReaderTests/TestInvalid.csv";
            using (var reader = new StreamReader(csvFilePath)) {
                var stream = reader.BaseStream;
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestReadInteger() {
            var tableDef = FakeTableDefinition();
            var csvFilePath = @"Resources/CsvReaderTests/Test.csv";
            using (var reader = new StreamReader(csvFilePath)) {
                var stream = reader.BaseStream;
        ...
        [TestMethod]
        public void CheckedDataTableReader_TestFailReadInteger() {
            var tableDef = FakeTableDefinition();
            var csvFilePath = @"Resources/CsvReaderTests/TestInvalid.csv";
            using (var reader = new StreamReader(csvFilePath)) {
                var stream = reader.BaseStream;
        ...
        private static CheckedDataTableReader CreateWrappedCsvReader(Stream stream, TableDefinition tableDefinition) {
            return new CheckedDataTableReader(new CsvDataReader(stream), tableDefinition);
        }
        ...
        private static List<T> ReadAllColumnValues<T>(CheckedDataTableReader reader, string fieldName) {
