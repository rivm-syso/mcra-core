...
namespace MCRA.Simulation.Calculators.KineticModelCalculation.PbpkModelCalculation.ReverseDoseCalculation {
    public class ReverseDoseCalculator {
        ...
        public double Reverse(
            PbkModelCalculatorBase pbkModelCalculator,
            ...
            double f(double x) {
                var targetDose = pbkModelCalculator
                    .Forward(
                        individual,
                        x,
