...
namespace MCRA.Simulation.Calculators.DustExposureCalculation {
    public abstract class DustExposureGenerator {
        ...
        /// <summary>
        /// Generates acute dust individual day exposures.
        /// </summary>
        public List<DustIndividualDayExposure> GenerateAcuteDustIndividualDayExposures(
        ...
        /// Generates acute dust individual day exposures.
        /// </summary>
        public List<DustIndividualDayExposure> GenerateChronicDustIndividualDayExposures(
            ICollection<IIndividualDay> individualDays,
            ICollection<Compound> substances,
            ICollection<DustIndividualDayExposure> dustIndividualDayExposures,
            int seed,
