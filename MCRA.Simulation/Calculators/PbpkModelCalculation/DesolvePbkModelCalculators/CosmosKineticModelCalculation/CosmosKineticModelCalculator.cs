...
namespace MCRA.Simulation.Calculators.PbpkModelCalculation.DesolvePbkModelCalculators.CosmosKineticModelCalculation {
    ...
    public sealed class CosmosKineticModelCalculator : DesolvePbkModelCalculator {
        ...
        protected override Dictionary<string, double> drawParameters(
            ...
            var result = base.drawParameters(parameters, random, useParameterVariability);
