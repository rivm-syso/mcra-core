...
namespace MCRA.Simulation.OutputGeneration {
    ...
    public sealed class ExternalContributionBySourceRecord {
        ...
        [Description("Relative contribution of a source to exposure, including RPF's, membership probabilities and absorption factors.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a source to exposure.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a source to exposure.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a source to exposure")]
