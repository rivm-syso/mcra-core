...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ExternalContributionsBySourceUpperPieChartCreator : ReportPieChartCreatorBase {
        ...
        private ExternalContributionsBySourceUpperSection _section;
        private bool _isUncertainty;
        public ExternalContributionsBySourceUpperPieChartCreator(ExternalContributionsBySourceUpperSection section, bool isUncertainty) {
            Width = 500;
            Height = 350;
            _section = section;
