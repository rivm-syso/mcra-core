...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ExternalContributionBySourceRouteTotalPieChartCreator : ReportPieChartCreatorBase {

        private readonly ExternalContributionBySourceRouteTotalSection _section;
        private readonly bool _isUncertainty;
        public ExternalContributionBySourceRouteTotalPieChartCreator(ExternalContributionBySourceRouteTotalSection section, bool isUncertainty) {
            Width = 500;
            Height = 350;
            _section = section;
        ...
        public override string ChartId {
            get {
                var pictureId = "164e59a0-46df-442d-9108-6200a575993b";
