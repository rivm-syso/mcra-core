...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ContributionBySourceUpperPieChartCreator : ReportPieChartCreatorBase {

        private readonly ContributionBySourceUpperSection _section;
        private readonly bool _isUncertainty;
        public ContributionBySourceUpperPieChartCreator(ContributionBySourceUpperSection section, bool isUncertainty) {
            Width = 500;
            Height = 350;
            _section = section;
        ...
        public override string ChartId {
            get {
                var pictureId = "a0499ab9-fa16-4496-9373-663976107d0a";
