...
namespace MCRA.Simulation.OutputGeneration {
    ...
    public sealed class ContributionBySourceRouteSubstanceUpperSection : InternalExposureContributionSectionBase<SourceRouteSubstanceContributorKey, ContributionBySourceRouteSubstanceRecord> {
