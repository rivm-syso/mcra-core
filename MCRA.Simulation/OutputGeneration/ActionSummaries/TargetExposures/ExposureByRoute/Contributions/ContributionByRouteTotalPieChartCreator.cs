...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ContributionByRouteTotalPieChartCreator : ReportPieChartCreatorBase {

        private readonly ContributionByRouteTotalSection _section;
        private readonly bool _isUncertainty;
        public ContributionByRouteTotalPieChartCreator(ContributionByRouteTotalSection section, bool isUncertainty) {
            Width = 500;
            Height = 350;
            _section = section;
