...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ContributionByRouteUpperPieChartCreator : ReportPieChartCreatorBase {

        private readonly ContributionByRouteUpperSection _section;
        private readonly bool _isUncertainty;
        public ContributionByRouteUpperPieChartCreator(ContributionByRouteUpperSection section, bool isUncertainty) {
            Width = 500;
            Height = 350;
            _section = section;
