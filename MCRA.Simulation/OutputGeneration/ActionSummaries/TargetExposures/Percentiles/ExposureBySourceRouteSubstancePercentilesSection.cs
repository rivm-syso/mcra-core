...
namespace MCRA.Simulation.OutputGeneration {
    ...
    public sealed class ExposureBySourceRouteSubstancePercentilesSection : ExposureBySourceRouteSubstanceSectionBase {
        ...
        public void Summarize(
            ...
            foreach (var (path, substance, exposures) in exposureCollection) {
