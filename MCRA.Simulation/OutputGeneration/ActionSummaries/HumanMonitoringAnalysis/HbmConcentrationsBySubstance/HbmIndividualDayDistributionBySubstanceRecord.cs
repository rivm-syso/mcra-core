...
namespace MCRA.Simulation.OutputGeneration {
    ...
    public sealed class HbmIndividualDayDistributionBySubstanceRecord {
        ...
        [DisplayName("Mean all individual days")]
        ...
        [DisplayName("{UpperPercentage} all individual days")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
        ...
        [DisplayName("Mean individual days positive concentrations")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
        ...
        [DisplayName("Median individual days positive concentrations")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
        ...
        [DisplayName("{LowerPercentage} individual days positive concentrations")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
        ...
        [DisplayName("{UpperPercentage} individual days positive concentrations")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
