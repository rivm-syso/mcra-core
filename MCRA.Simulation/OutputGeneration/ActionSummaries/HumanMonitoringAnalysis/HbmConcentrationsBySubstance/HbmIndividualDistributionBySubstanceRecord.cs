...
namespace MCRA.Simulation.OutputGeneration {
    ...
    public sealed class HbmIndividualDistributionBySubstanceRecord {
        ...
        [DisplayName("{LowerPercentage} all individuals ({MonitoringConcentrationUnit})")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
        ...
        [DisplayName("{UpperPercentage} all individuals ({MonitoringConcentrationUnit})")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
        ...
        [DisplayName("{UpperPercentage} individuals positive concentrations ({MonitoringConcentrationUnit})")]
        [DisplayFormat(DataFormatString = "{0:G3}")]
