    ...
    public class ConsumerProductConcentrationModelSectionBase : SummarySection {
        ...
        protected static ConsumerProductConcentrationModelRecord SummarizeBase(
            ...
            var record = new ConsumerProductConcentrationModelRecord {
                ...
                ConsumerProductCode = product.Code,
                ConsumerProductName = product.Name,
            ...
            if (createHistogramBins && (concentrationModel.Residues?.Positives.Any() ?? false)) {
                ...
                var lORsSmallerThanMin = record.LORs.Where(lor => lor > 0 && Math.Log(lor) <= logPositiveResidueMeasurements.Min());
                ...
                if (min == max) {
                    ...
                    record.LogPositiveResiduesBins = logPositiveResidueMeasurements.MakeHistogramBins(numberOfBins, min, max);
                } else {
