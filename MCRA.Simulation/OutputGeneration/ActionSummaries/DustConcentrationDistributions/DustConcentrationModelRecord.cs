...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// </summary>
    public sealed class DustConcentrationModelRecord {

        private Guid _id = Guid.NewGuid();

        public DustConcentrationModelRecord() {
        }
        ...
        [Description("The concentration model type specified in the concentration model section. If model fitting " +
            "fails, a simpler (fallback) model is taken that overrules the model specified in the concentration " +
            "model section (see, fitted model).")]
        ...
        [Description("The derived percentage of consumer product samples potentially containing residues of this " +
            "substance, corrected for actual the percentage of positives encountered in the data.")]
        [DisplayName("Corrected potential presence (%)")]
        [DisplayFormat(DataFormatString = "{0:P2}")]
        public double? CorrectedAgriculturalUseFraction { get; set; }

        [Description("The derived percentage of consumer product samples potentially containing residues of " +
            "this substance.")]
        ...
        [Description("Mean concentration according to this model (also includes values according to censored " +
            "handling method).")]
