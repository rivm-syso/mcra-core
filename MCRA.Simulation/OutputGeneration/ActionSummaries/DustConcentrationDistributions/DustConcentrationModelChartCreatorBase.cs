...
namespace MCRA.Simulation.OutputGeneration {
    public abstract class DustConcentrationModelChartCreatorBase : ReportHistogramChartCreatorBase {

        protected DustConcentrationModelRecord _record;
        protected bool _showTitle;

        public DustConcentrationModelChartCreatorBase(
            DustConcentrationModelRecord concentrationModelRecord,
            int height,
            int width,
            bool showTitle
        ) {
        ...
        protected PlotModel createCensoredValuesBarSeries(DustConcentrationModelRecord record) {
