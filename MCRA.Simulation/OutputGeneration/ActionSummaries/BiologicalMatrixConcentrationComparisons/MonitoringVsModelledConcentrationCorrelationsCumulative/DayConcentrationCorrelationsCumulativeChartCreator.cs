...
namespace MCRA.Simulation.OutputGeneration {
    public class DayConcentrationCorrelationsCumulativeChartCreator : ConcentrationCorrelationsChartCreatorBase {
        ...
        protected virtual PlotModel createPlotModel(DayConcentrationCorrelationsCumulativeSection section, string codeSubstance, string modelledExposureUnit, string monitoringConcentrationUnit) {
