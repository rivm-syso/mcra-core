...
namespace MCRA.Simulation.OutputGeneration {
    ...
    public sealed class CumulativeDayConcentrationsSection : SummarySection {
        ...
        public void Summarize(
            ...
            HbmCumulativeIndividualDayCollection cumulativeHbmIndividualDayCollection,
            ...
            {
                var concentrationAlignmentFactor = cumulativeHbmIndividualDayCollection.TargetUnit
                    .GetAlignmentFactor(targetExposureUnit, referenceSubstance.MolecularMass, double.NaN);

                var hbmConcentrations = cumulativeHbmIndividualDayCollection.HbmCumulativeIndividualDayConcentrations
                    .Select(c => (
                ...
                var record = new BiologicalMatrixConcentrationPercentilesRecord {
                    ...
                    Type = "Monitoring",
                    BiologicalMatrix = cumulativeHbmIndividualDayCollection.TargetUnit.BiologicalMatrix.GetDisplayName(),
