        ...
        public void Summarize(
            ...
            foreach (var substance in substances) {
                ...
                var compoundTargetExposures = targetExposures
                    .Select(r => (
                        TargetExposure: r,
                        CompoundExposures: r.TargetExposuresBySubstance.ContainsKey(substance) ? r.TargetExposuresBySubstance[substance] : null
                    ))
                    .ToList();
                ...
                record.UnmatchedModelExposures = compoundTargetExposures.Where(r => !matchedIndividualDays.Contains(r.TargetExposure.Individual.Code)).Count();
                result.Add(record);
            }
