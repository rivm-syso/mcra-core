...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class TotalDistributionRiskEHDriversPieChartCreator : PieChartCreatorBase {

        private ExposureHazardRatioSubstanceSection _section;
        private bool _isUncertainty;

        public TotalDistributionRiskEHDriversPieChartCreator(ExposureHazardRatioSubstanceSection section, bool isUncertainty) {
            Width = 500;
            Height = 350;
            _section = section;
