...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ThresholdExposureRatioPercentileChartCreator : BoxPlotChartCreatorBase {

        private ThresholdExposureRatioPercentileSection _section;

        public ThresholdExposureRatioPercentileChartCreator(ThresholdExposureRatioPercentileSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        private PlotModel create(ThresholdExposureRatioPercentileSection section) {
            var plotModel = createDefaultPlotModel();

            var linearAxis2 = createLinearLeftAxis($"Threshold value/exposure");
