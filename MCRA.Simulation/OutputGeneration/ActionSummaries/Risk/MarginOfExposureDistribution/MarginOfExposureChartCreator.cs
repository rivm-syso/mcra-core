...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class MarginOfExposureChartCreator : HistogramChartCreatorBase {

        private MarginOfExposureDistributionSection _section;
        public MarginOfExposureChartCreator(MarginOfExposureDistributionSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        public override string Title => $"Margin of exposure total distribution ({100 - _section.PercentageZeros:F1}% positives)";

        public override PlotModel Create() {
            return create(_section.IMOEDistributionBins, _section.ThresholdMarginOfExposure);
        }
