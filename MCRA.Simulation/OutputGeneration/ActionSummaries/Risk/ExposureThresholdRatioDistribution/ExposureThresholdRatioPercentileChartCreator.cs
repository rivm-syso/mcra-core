...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ExposureThresholdRatioPercentileChartCreator : BoxPlotChartCreatorBase {

        private ExposureThresholdRatioPercentileSection _section;

        public ExposureThresholdRatioPercentileChartCreator(ExposureThresholdRatioPercentileSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        private PlotModel create(ExposureThresholdRatioPercentileSection section) {
            var plotModel = createDefaultPlotModel();

            var linearAxis2 = createLinearLeftAxis($"exposure/threshold value");
