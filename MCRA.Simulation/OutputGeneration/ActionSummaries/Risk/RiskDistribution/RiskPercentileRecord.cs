...
namespace MCRA.Simulation.OutputGeneration {
    public class RiskPercentileRecord {
        ...
        [Description("Risk at the specified percentile of the nominal analysis.")]
        ...
        [Description("Lower uncertainty bound (LowerBound) of the risk at the specified percentile.")]
        [DisplayName("Risk ({RiskMetricShort}) lower (LowerBound)")]
        [DisplayFormat(DataFormatString = "{0:G4}")]
        public double LowerBound { get; set; }

        [Description("Upper uncertainty bound (UpperBound) of the risk at the specified percentile.")]
        [DisplayName("Risk ({RiskMetricShort}) upper (UpperBound)")]
        [DisplayFormat(DataFormatString = "{0:G4}")]
