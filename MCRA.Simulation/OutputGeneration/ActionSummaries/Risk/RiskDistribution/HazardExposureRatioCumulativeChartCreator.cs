...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class HazardExposureRatioCumulativeChartCreator : CumulativeLineChartCreatorBase {

        private readonly HazardExposureRatioDistributionSection _section;

        public HazardExposureRatioCumulativeChartCreator(HazardExposureRatioDistributionSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        public override PlotModel Create() {
            return base.createPlotModel(
                ...
                $"Risk ratio ({RiskMetricType.MarginOfExposure.GetDisplayName()})"
           );
        }
    }
}
