...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ExposureHazardRatioChartCreator : ReportHistogramChartCreatorBase {

        private readonly ExposureHazardRatioDistributionSection _section;

        public ExposureHazardRatioChartCreator(ExposureHazardRatioDistributionSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        private PlotModel create(
            ...
            var xtitle = $"Risk characterisation ratio ({RiskMetricType.ExposureHazardRatio.GetDisplayName()})";
