...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class HazardExposureRatioChartCreator : ReportHistogramChartCreatorBase {
        ...
        public HazardExposureRatioChartCreator(HazardExposureRatioDistributionSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        private PlotModel create(
            ...
            var xtitle = $"Risk characterisation ratio ({RiskMetricType.HazardExposureRatio.GetDisplayName()})";
