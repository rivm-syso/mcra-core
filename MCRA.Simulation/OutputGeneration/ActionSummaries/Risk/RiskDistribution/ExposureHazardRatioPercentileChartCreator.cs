...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ExposureHazardRatioPercentileChartCreator : BoxPlotChartCreatorBase {

        private ExposureHazardRatioPercentileSection _section;

        public ExposureHazardRatioPercentileChartCreator(ExposureHazardRatioPercentileSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
