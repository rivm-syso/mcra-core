...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for substances, relative contribution to the threshold value/exposure distribution.
    /// </summary>
    public sealed class ThresholdExposureRatioSubstanceRecord {
        ...
        [Description("Relative contribution of a substance to the threshold value/exposure.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a substance to the threshold value/exposure.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a substance to the threshold value/exposure.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a substance to the threshold value/exposure.")]
