...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for substances, relative contribution to the exposure/threshold value distribution.
    /// </summary>
    public sealed class ExposureThresholdRatioSubstanceRecord  {
        ...
        [Description("Relative contribution of a substance to exposure/threshold value.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a substance to the exposure/threshold value.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a substance to the exposure/threshold value.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a substance to the exposure/threshold value.")]
