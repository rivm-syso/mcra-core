...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for modelled foods, relative contribution to the hazard index distribution.
    /// </summary>
    public sealed class HazardIndexModelledFoodRecord  {
        ...
        [Description("Relative contribution of a food to hazard index.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a food to the hazard index.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a food to the hazard index.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a food to the hazard index.")]
        ...
        [Description("Mean hazard index for a food on all individual days (acute) or individuals (chronic).")]
