...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class MarginOfExposureModelledFoodSection : SummarySection {
        ...
        public List<MarginOfExposureModelledFoodRecord> Records { get; set; }
       ...
       public void SummarizeRiskByFoods(
            ...
            Records = individualEffects.Keys.Select(food => {
                return createMarginOfExposureFoodRecord(individualEffects[food], food, totalExposure);
            }).OrderByDescending(c => c.Contribution).ToList();
            setUncertaintyBounds(uncertaintyLowerBound, uncertaintyUpperBound);
        }

        private MarginOfExposureModelledFoodRecord createMarginOfExposureFoodRecord(
        ...
        public void SummarizeFoodsUncertainty(Dictionary<Food, List<IndividualEffect>> individualEffects) {
            ...
            var records = individualEffects.Keys
                .Select(food => new MarginOfExposureModelledFoodRecord() {
                    FoodCode = food.Code,
        ...
        private void updateContributions(List<MarginOfExposureModelledFoodRecord> records) {
