...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ExposureThresholdRatioModelledFoodSection : SummarySection {
        ...
        public List<ExposureThresholdRatioModelledFoodRecord> Records { get; set; }
        ...
        public void SummarizeRiskByFoods(
            ...
            Records = individualEffects.Keys.Select(food => {
                return createExposureThresholdRatioFoodRecord(individualEffects[food], food, totalExposure);
            }).OrderByDescending(c => c.Contribution).ToList();
            setUncertaintyBounds(uncertaintyLowerBound, uncertaintyUpperBound);
        }

        private ExposureThresholdRatioModelledFoodRecord createExposureThresholdRatioFoodRecord(
            ...
            var records = new ExposureThresholdRatioModelledFoodRecord() {
                FoodName = food.Name,
                FoodCode = food.Code,
        ...
        public void SummarizeFoodsUncertainty(Dictionary<Food, List<IndividualEffect>> individualEffects) {
            ...
            var records = individualEffects.Keys.Select(food => {
                return new ExposureThresholdRatioModelledFoodRecord() {
                    FoodCode = food.Code,
        ...
        private void updateContributions(List<ExposureThresholdRatioModelledFoodRecord> records) {
