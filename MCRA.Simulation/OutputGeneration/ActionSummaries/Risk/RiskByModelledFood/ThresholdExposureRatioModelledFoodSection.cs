...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class ThresholdExposureRatioModelledFoodSection : SummarySection {
        ...
        public List<ThresholdExposureRatioModelledFoodRecord> Records { get; set; }
       ...
       public void SummarizeRiskByFoods(
            ...
            Records = individualEffects.Keys.Select(food => {
                return createThresholdExposureRatioFoodRecord(individualEffects[food], food, totalExposure);
            }).OrderByDescending(c => c.Contribution).ToList();
            setUncertaintyBounds(uncertaintyLowerBound, uncertaintyUpperBound);
        }

        private ThresholdExposureRatioModelledFoodRecord createThresholdExposureRatioFoodRecord(
            ...
            var record = new ThresholdExposureRatioModelledFoodRecord() {
                FoodName = $"{food.Name}",
                FoodCode = $"{food.Code}",
        ...
        public void SummarizeFoodsUncertainty(Dictionary<Food, List<IndividualEffect>> individualEffects) {
            ...
            var records = individualEffects.Keys
                .Select(food => new ThresholdExposureRatioModelledFoodRecord() {
                    FoodCode = food.Code,
        ...
        private void updateContributions(List<ThresholdExposureRatioModelledFoodRecord> records) {
