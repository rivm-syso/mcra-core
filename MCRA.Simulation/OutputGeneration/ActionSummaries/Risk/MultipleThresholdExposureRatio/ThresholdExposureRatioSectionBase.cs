...
namespace MCRA.Simulation.OutputGeneration {
    public class ThresholdExposureRatioSectionBase : SummarySection {

        public override bool SaveTemporaryData => true;

        private readonly double _eps = 10E7D;

        public List<ThresholdExposureRatioRecord> RiskRecords { get; set; }
        ...
        public List<ThresholdExposureRatioRecord> GetThresholdExposureRatioSingleRecord(
           Compound substance,
           ...
           bool isCumulative
            ...
            var records = new List<ThresholdExposureRatioRecord>();
            ...
            if (individualEffects != null && isCumulative) {
                ...
                records.Add(createSubstanceThresholdExposureRatioRecord(individualEffects, substance, false, isInverseDistribution));
            }
            return records;
        }
        ...
        /// <returns></returns>
        protected ThresholdExposureRatioRecord createSubstanceThresholdExposureRatioRecord(
            List<IndividualEffect> individualEffects,
            Compound substance,
            ...
            var result = new ThresholdExposureRatioRecord() {
                ...
                ThresholdExposureRatioPercentiles = new UncertainDataPointCollection<double>() {
