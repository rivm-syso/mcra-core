...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class MultipleThresholdExposureRatioHeatMapCreator : OxyPlotChartCreator {
        ...
        public override PlotModel Create() {
            ...
            return create(xlow, xhigh, threshold, _section.RiskRecords, _isUncertainty, _intakeUnit, _section.CED);
        }

        private static PlotModel create(double xLow, double xHigh, double xNeutral, List<ThresholdExposureRatioRecord> terStatistics, bool isUncertainty, string intakeUnit, double CED = double.NaN) {
            ...
            var horizontalAxis = new LogarithmicAxis() {
                ...
                Title = "Threshold value/exposure"
            };
