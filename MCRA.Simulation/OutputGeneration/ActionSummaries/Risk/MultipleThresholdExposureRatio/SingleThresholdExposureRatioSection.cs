...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class SingleThresholdExposureRatioSection : ThresholdExposureRatioSectionBase {
        ...
        public void SummarizeSingleSubstance(
            ...
            RiskRecords = GetThresholdExposureRatioSingleRecord(
                substance,
                individualEffects,
        ...
        public void SummarizeSingleSubstanceUncertainty(
            ...
            var recordsLookup = RiskRecords.ToDictionary(r => r.CompoundCode);
            var records = GetThresholdExposureRatioSingleRecord(
                substance,
                individualEffects,
                riskMetricCalculationType,
                isInverseDistribution,
            ...
            foreach (var item in records) {
                ...
                record.ThresholdExposureRatioPercentiles.AddUncertaintyValues(new List<double> { item.PLowerRiskNom, item.RiskP50Nom, item.PUpperRiskNom });
