...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class HazardExposure_MOEExpCedvsUpperExpCed100ChartCreator : HazardExposureHeatMapCreatorBase {

        public HazardExposure_MOEExpCedvsUpperExpCed100ChartCreator(
        ...
        public override string ChartId {
            get {
                var pictureId = "0b910c30-876f-46ea-ac8d-a040debcf6dd";
        ...
        private PlotModel create(HazardExposureSection section) {
            ...
            foreach (var item in records) {
                ...
                if (_isUncertainty) {
                    ...
                    var coordLowerU1 = GetCoordinates(_xLow, item.UpperExposure, item.NominalHazardCharacterisation, lowerRiskUnc, false);
                    var coordUpperU1 = GetCoordinates(_xLow, item.UpperExposure, item.NominalHazardCharacterisation, lowerRisk, false);
                ...
                if (label != string.Empty && counter < section.NumberOfLabels) {
                    ...
                    var labelConnection = createLabelConnection(positionBottomLabel, ticks, counter, coordUpper1);
