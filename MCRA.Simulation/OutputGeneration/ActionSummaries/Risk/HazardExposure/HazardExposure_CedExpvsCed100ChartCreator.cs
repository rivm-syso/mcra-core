...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class HazardExposure_CedExpvsCed100ChartCreator : HazardExposureHeatMapCreatorBase {

        public HazardExposure_CedExpvsCed100ChartCreator(
        ...
        public override string ChartId {
            get {
                var pictureId = "aa1671ff-93cc-4776-941f-ca773fbdade7";
