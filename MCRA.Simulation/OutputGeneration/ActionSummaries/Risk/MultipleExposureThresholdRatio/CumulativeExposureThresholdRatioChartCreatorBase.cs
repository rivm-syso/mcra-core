...
namespace MCRA.Simulation.OutputGeneration {
    public class CumulativeExposureThresholdRatioChartCreatorBase : OxyPlotChartCreator {
        ...
        protected static PlotModel create(
            ...
            var yAxis = new LinearAxis() { Title = $"Cumulative Exp/Threshold {percentage:F0}" };
            ...
            if (!double.IsNaN(rpfWeightedRisk)) {
                ...
                var annotation = new LineAnnotation() { Text = "Cumulative RPF weighted Exp/Threshold", Y = rpfWeightedRisk, Type = LineAnnotationType.Horizontal, };
