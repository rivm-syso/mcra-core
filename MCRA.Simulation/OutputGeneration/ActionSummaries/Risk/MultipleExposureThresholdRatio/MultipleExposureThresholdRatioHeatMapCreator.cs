...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class MultipleExposureThresholdRatioHeatMapCreator : OxyPlotChartCreator {

        private MultipleExposureThresholdRatioSection _section;
        private bool _isUncertainty;
        private string _intakeUnit;

        public MultipleExposureThresholdRatioHeatMapCreator(MultipleExposureThresholdRatioSection section, bool isUncertainty, string intakeUnit) {
            _section = section;
            _isUncertainty = isUncertainty;
            var xLow = _section.LeftMargin;
            var records = _section.ExposureThresholdRatioRecords
        ...
        public override PlotModel Create() {
            ...
            return create(
                ...
                xHigh: xhigh,
                xNeutral: threshold,
                hiStatistics: _section.ExposureThresholdRatioRecords,
        ...
        private static PlotModel create(
            ...
            double xHigh,
            double xNeutral,
            List<ExposureThresholdRatioRecord> hiStatistics,
            bool isUncertainty,
            string intakeUnit,
            ...
            if (riskStatisticsPositives.Any(c => c.RiskP50UncP50 > 0)) {
                riskStatisticsPositives = riskStatisticsPositives.OrderBy(c => c.PUpperRisk_UncUpper).Where(c => c.PUpperRiskUncP50 > xLow).ToList();
            } else {
            ...
            var horizontalAxis = new LogarithmicAxis() {
                ...
                Title = "Exposure/threshold value"
            };
            ...
            foreach (var item in riskStatisticsPositives) {
                ...
                if (isUncertainty) {
                    ...
                    wiskerLow = item.PLowerRisk_UncLower;
                    wiskerHigh = item.PUpperRisk_UncUpper;
                }
