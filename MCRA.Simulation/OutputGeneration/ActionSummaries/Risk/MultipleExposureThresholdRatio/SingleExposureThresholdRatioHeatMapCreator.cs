...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class SingleExposureThresholdRatioHeatMapCreator : OxyPlotChartCreator {
        ...
        private SingleExposureThresholdRatioSection _section;
        ...
        public override PlotModel Create() {
            ...
            var ihiRecord = _section.ExposureThresholdRatioRecords.First();
            ...
            if (_isUncertainty) {
                p1_lower95 = ihiRecord.PLowerRisk_UncLower != 0 ? ihiRecord.PLowerRisk_UncLower : _eps;
                p99_upper95 = ihiRecord.PUpperRisk_UncUpper;
            }
