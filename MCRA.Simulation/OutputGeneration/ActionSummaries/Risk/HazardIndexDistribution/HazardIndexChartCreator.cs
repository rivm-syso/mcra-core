...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class HazardIndexChartCreator : HistogramChartCreatorBase {

        private HazardIndexDistributionSection _section;

        public HazardIndexChartCreator(HazardIndexDistributionSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        public override string Title => $"Hazard index total distribution ({100 - _section.PercentageZeros:F1}% positives)";

        public override PlotModel Create() {
            return create(_section.HIDistributionBins, _section.ThresholdHazardIndex);
        }
