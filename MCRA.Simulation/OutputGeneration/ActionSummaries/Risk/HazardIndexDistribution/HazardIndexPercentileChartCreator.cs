...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class HazardIndexPercentileChartCreator : BoxPlotChartCreatorBase {
        ...
        private HazardIndexPercentileSection _section;

        public HazardIndexPercentileChartCreator(HazardIndexPercentileSection section) {
            Width = 500;
            Height = 350;
            _section = section;
        }
        ...
        private PlotModel create(HazardIndexPercentileSection section) {
            var plotModel = createDefaultPlotModel();

            var linearAxis2 = createLinearLeftAxis($"hazard index");
