...
namespace MCRA.Simulation.OutputGeneration {
    public class ThresholdExposureRatioSectionBase : SummarySection {
        ...
        public List<SubstanceRiskDistributionRecord> GetThresholdExposureRatioSingleRecord(
           Compound substance,
        ...
        /// <returns></returns>
        protected SubstanceRiskDistributionRecord createSubstanceThresholdExposureRatioRecord(
            List<IndividualEffect> individualEffects,
            Compound substance,
