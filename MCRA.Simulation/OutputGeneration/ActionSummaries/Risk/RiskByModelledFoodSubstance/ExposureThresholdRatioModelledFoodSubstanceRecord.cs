...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for modelled food x substances, relative contribution to the exposure/threshold value distribution.
    /// </summary>
    public sealed class ExposureThresholdRatioModelledFoodSubstanceRecord {
        ...
        [Description("Relative contribution of a modelled food x substance to exposure/threshold value.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a modelled food x substance to the exposure/threshold value.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a modelled food x substance to the exposure/threshold value.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a modelled food x substance to the exposure/threshold value.")]
        ...
        [Description("Mean exposure/threshold value for a substance on all individual days (acute) or individuals (chronic).")]
