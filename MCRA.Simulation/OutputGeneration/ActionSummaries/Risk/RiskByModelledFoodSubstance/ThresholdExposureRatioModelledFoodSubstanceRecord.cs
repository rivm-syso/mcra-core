...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for modelled food x susbtances, relative contribution to the threshold value/exposure distribution.
    /// </summary>
    public sealed class ThresholdExposureRatioModelledFoodSubstanceRecord {
        ...
        [Description("Relative contribution of a modelled food x substance to the threshold value/exposure.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a modelled food x substance to the threshold value/exposure.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a modelled food x substance to the threshold value/exposure.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a modelled food x substance to the threshold value/exposure.")]
        ...
        [Description("Mean threshold value/exposure for a substance on all individual days (acute) or individuals (chronic).")]
