...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for modelled food x substances, relative contribution to the hazard index distribution.
    /// </summary>
    public sealed class HazardIndexModelledFoodSubstanceRecord {
        ...
        [Description("Relative contribution of a modelled food x substance to hazard index.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a modelled food x substance to the hazard index.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a modelled food x substance to the hazard index.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a modelled food x substance to the hazard index.")]
