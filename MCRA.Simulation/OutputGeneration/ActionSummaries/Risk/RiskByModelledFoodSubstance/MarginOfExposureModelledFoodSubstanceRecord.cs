...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for modelled food x susbtances, relative contribution to the margin of exposure distribution.
    /// </summary>
    public sealed class MarginOfExposureModelledFoodSubstanceRecord {
        ...
        [Description("Relative contribution of a modelled food x substance to the margin of exposure.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a modelled food x substance to the margin of exposure.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a modelled food x substance to the margin of exposure.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a modelled food x substance to the margin of exposure.")]
