...
namespace MCRA.Simulation.OutputGeneration {
    public abstract class IviveHazardCharacterisationsHistogramChartCreatorBase : ReportHistogramChartCreatorBase {

        private readonly string _targetDoseUnit;

        protected readonly ICollection<IviveHazardCharacterisationsSummaryRecord> _records;

        public IviveHazardCharacterisationsHistogramChartCreatorBase(
            ICollection<IviveHazardCharacterisationsSummaryRecord> records,
