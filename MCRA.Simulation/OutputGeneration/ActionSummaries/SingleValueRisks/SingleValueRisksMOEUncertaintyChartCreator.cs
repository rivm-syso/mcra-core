...
namespace MCRA.Simulation.OutputGeneration {
    public sealed class SingleValueRisksMOEUncertaintyChartCreator : SingleValueRisksUncertaintyChartCreatorBase {
        ...
        public SingleValueRisksMOEUncertaintyChartCreator(SingleValueRisksMarginOfExposureSection section)
            : base(section) {
        }
        ...
        public override string ChartId {
            get {
                ...
                return StringExtensions.CreateFingerprint(_moeSection.SectionId + pictureId);
            }
        }
