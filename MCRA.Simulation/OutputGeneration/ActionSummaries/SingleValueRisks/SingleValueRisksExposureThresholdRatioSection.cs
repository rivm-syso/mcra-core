    ...
    public sealed class SingleValueRisksExposureThresholdRatioSection : ActionSummaryBase {
        ...
        public void SummarizeUncertainty(
            ...
            foreach (var record in Records) {
                ...
                record.Risks.Add(results.First().ExposureThresholdRatio);
                record.ReferenceValueExposures.Add(results.First().Exposure);
                record.AdjustedRisks.Add(results.First().ExposureThresholdRatio / (adjustmentFactorExposure * adjustmentFactorHazard * (1 - focalCommodityContribution) + focalCommodityContribution));
            }
        }
    }
}
