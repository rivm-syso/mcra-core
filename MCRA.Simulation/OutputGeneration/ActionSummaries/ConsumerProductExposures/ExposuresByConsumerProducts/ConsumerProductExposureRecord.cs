...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// <summary>
    /// Helper class for consumer products, relative contribution to the upper tail of the exposure distribution.
    /// </summary>
    public sealed class ConsumerProductExposureRecord : HierarchyRecord {
        ...
        [Description("Relative contribution of a consumer product to exposure.")]
        [DisplayName("Contribution (%)")]
        [DisplayFormat(DataFormatString = "{0:F1}")]
        public double ContributionPercentage { get { return Contribution * 100; } }

        [Description("Mean relative contribution of a consumer product to exposure.")]
        ...
        [Description("Lower uncertainty bound relative contribution of a consumer product to exposure.")]
        ...
        [Description("Upper uncertainty bound relative contribution of a consumer product to exposure.")]
        ...
        [Description("Mean exposure for a consumer product on all individuals (chronic).")]
