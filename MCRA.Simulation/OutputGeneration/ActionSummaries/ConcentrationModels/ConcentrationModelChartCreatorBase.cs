...
namespace MCRA.Simulation.OutputGeneration {
    public abstract class ConcentrationModelChartCreatorBase : ReportHistogramChartCreatorBase {
        ...
        public ConcentrationModelChartCreatorBase(
            ConcentrationModelRecord record,
            int height,
            int width,
            bool showTitle
        ) {
        ...
        protected PlotModel createCensoredValuesBarSeries(ConcentrationModelRecord record) {
