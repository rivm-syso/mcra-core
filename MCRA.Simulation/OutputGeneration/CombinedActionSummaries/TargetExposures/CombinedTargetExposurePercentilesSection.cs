...
namespace MCRA.Simulation.OutputGeneration {
    ...
    /// </summary>
    public sealed class CombinedTargetExposurePercentilesSection : CombinedPercentilesSectionBase {
        public ExternalExposureUnit ExposureUnit { get; set; }

        public void Summarize(ICollection<TargetExposureModel> exposureModels) {
            Percentages = [.. exposureModels.SelectMany(r => r.TargetExposurePercentiles.Keys).Distinct()];
