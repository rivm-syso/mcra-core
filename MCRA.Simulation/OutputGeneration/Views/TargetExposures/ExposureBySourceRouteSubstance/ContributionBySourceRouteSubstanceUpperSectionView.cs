...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class ContributionBySourceRouteSubstanceUpperSectionView : SectionView<ContributionBySourceRouteSubstanceUpperSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (Model.Records.Count > 0) {
                var chartCreator = new ContributionBySourceRouteSubstanceUpperPieChartCreator(Model, isUncertainty);
                sb.AppendChart(
                    "UpperDistributionSourceRouteSubstanceChart",
                    chartCreator,
                    ChartFileType.Svg,
                    Model,
                    ViewBag,
                ...
                sb.AppendTable(
                    Model,
                    Model.Records,
                    "ExposureBySourceRouteSubstanceUpperTable",
                    ViewBag,
                    caption: $"Contributions by source, route and substance for the upper distribution (estimated {Model.CalculatedUpperPercentage:F1}%).",
                    saveCsv: true,
