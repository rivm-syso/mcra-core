...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class TotalDistributionSubstanceSectionView : SectionView<TotalDistributionSubstanceSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (records.Count > 0) {
                ...
                if (records.Count(r => !double.IsNaN(r.ContributionPercentage)) > 1) {
                    var chartCreator = new TotalDistributionSubstancePieChartCreator(Model, isUncertainty);
                    sb.AppendChart(
            ...
            if (records.Count > 0) {
                ...
                sb.AppendTable(
                    Model,
                    records,
                    "TotalDistributionSubstanceTable",
                    ViewBag,
                    caption: caption,
                    saveCsv: true,
