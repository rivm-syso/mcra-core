...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class OccupationalTaskExposuresPerRouteSectionView : SectionView<OccupationalTaskExposuresPerRouteSection> {
        ...
        public override void RenderSectionHtml(StringBuilder sb) {
            if (Model.Records.Any()) {
                ...
                sb.AppendTable(
                    Model,
                    Model.Records,
                    "OccupationalTaskExposuresPerRouteTable",
                    ViewBag,
                    caption: "Selected scenarios and tasks with exposures.",
                    saveCsv: true,
                    hiddenProperties: hiddenProperties
                );
            } else {
                sb.AppendDescriptionParagraph("No occupational task exposures per route available.");
            }
        }
    }
}
