...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class AirExposuresByRouteSubstanceSectionView : SectionView<AirExposuresByRouteSubstanceSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (missingRouteData.Count > 0) {
                var description = $"Note: air exposure data missing for {missingRouteData.Count} " +
            ...
            if (positivesRecords.Any()) {
                ...
                foreach (var boxPlotRecord in Model.BoxPlotRecords) {
                    ...
                    var percentileDataSection = DataSectionHelper.CreateCsvDataSection(
                        name: $"AirExposuresByRouteSubstancePercentiles{targetCode}",
                        section: Model,
                        items: boxPlotRecord.Value,
                        viewBag: ViewBag
                    );

                    var chartCreator = new AirExposuresByRouteSubstanceBoxPlotChartCreator(
                    ...
                    panelBuilder.AddPanel(
                        ...
                        content: ChartHelpers.Chart(
                            name: $"AirExposuresByRouteSubstanceBoxPlotChart{targetCode}",
                            section: Model,
                            viewBag: ViewBag,
                ...
                sb.AppendNotification("No air exposures available.");
            }
        }
    }
}
