...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class HazardIndexModelledFoodSubstanceSectionView : SectionView<HazardIndexModelledFoodSubstanceSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (Model.Records.Any()) {
                ...
                sb.AppendTable(
                    ...
                    ViewBag,
                    caption: "Hazard index statistics by modelled food x substance (total distribution).",
                    saveCsv: true,
                    displayLimit: 20,
