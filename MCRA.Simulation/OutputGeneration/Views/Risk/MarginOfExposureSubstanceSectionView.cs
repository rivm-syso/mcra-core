...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class MarginOfExposureSubstanceSectionView : SectionView<MarginOfExposureSubstanceSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (Model.Records.Any()) {
                ...
                sb.AppendTable(
                    ...
                    ViewBag,
                    caption: "Margin of exposure statistics by substance (total distribution).",
                    saveCsv: true,
                    displayLimit: 20,
