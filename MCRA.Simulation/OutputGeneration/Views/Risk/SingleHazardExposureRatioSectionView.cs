...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class SingleHazardExposureRatioSectionView : SectionView<SingleHazardExposureRatioSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            // Figure
            var caption = $"Safety chart: the bar shows variability ({pLower} - {pUpper}) of the risk characterisation ratio ({Model.RiskMetricType.GetDisplayName()}) in the population.";
            if (isUncertainty) {
                caption = caption
            ...
            sb.AppendChart(
                ...
                chartCreator: new SingleHazardExposureRatioHeatMapCreator(Model, isUncertainty),
                ChartFileType.Png,
                Model,
                ViewBag,
                caption: caption,
