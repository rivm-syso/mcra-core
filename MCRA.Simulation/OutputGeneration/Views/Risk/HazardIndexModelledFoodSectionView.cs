...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class HazardIndexModelledFoodSectionView : SectionView<HazardIndexModelledFoodSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (Model.Records.Any()) {
                ...
                sb.AppendTable(
                    ...
                    ViewBag,
                    caption: "Hazard index statistics by modelled food (total distribution).",
                    saveCsv: true,
                    displayLimit: 20,
