...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class ExposureThresholdRatioDistributionSectionView : SectionView<ExposureThresholdRatioDistributionSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            var chartCreator = new ExposureThresholdRatioChartCreator(Model);
            sb.AppendChart(
            ...
            var chartCreator1 = new ExposureThresholdRatioCumulativeChartCreator(Model);
            sb.AppendChart(
