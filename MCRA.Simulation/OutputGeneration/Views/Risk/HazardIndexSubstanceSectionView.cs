...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class HazardIndexSubstanceSectionView : SectionView<HazardIndexSubstanceSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (Model.Records.Any()) {
                ...
                sb.AppendTable(
                    Model,
                    Model.Records,
                    "HazardIndexBySubstance1Table",
                    ViewBag,
                    caption: "Hazard index statistics by substance (total distribution).",
                    saveCsv: true,
                    displayLimit: 20,
