...
namespace MCRA.Simulation.OutputGeneration.Views {
    public class MarginOfExposureModelledFoodSubstanceSectionView : SectionView<MarginOfExposureModelledFoodSubstanceSection> {
        public override void RenderSectionHtml(StringBuilder sb) {
            ...
            if (Model.Records.Any()) {
                ...
                sb.AppendTable(
                    ...
                    ViewBag,
                    caption: "Margin of exposure statistics by modelled food x substance (total distribution).",
                    saveCsv: true,
                    displayLimit: 20,
