...
namespace MCRA.Utils.Charting.OxyPlot {
    ...
    public  static class CustomPalettes  {
        ...
        private static readonly byte[] _distinctTone = [
        ...
        private static readonly byte[] _earthTone = [
        ...
        private static readonly byte[] _artDecoTone = [
        ...
        private static readonly byte[] _lightBlueTone = [
        ...
        private static readonly byte[] _gorgeousTone = [
        ...
        private static readonly byte[] _coolTone = [
        ...
        private static readonly byte[] _beachTone = [
        ...
        private static readonly byte[] _warmTone = [
        ...
        private static readonly byte[] _purpleTone = [
        ...
        private static readonly byte[] _elegantTone = [
        ...
        private static readonly byte[] _greenTone = [
        ...
        /// </summary>
        /// <returns></returns>
        public static OxyPalette BlueTone(int number) => Monochrome(number, 0.5883, .2, .5, 1, 1, true);
        ...
        /// </summary>
        /// <returns></returns>
        public static OxyPalette EarthTone(int number) => new(getPalette(_earthTone).Take(number));
        ...
        /// <returns></returns>
        public static OxyPalette EarthToneReverse(int number) => new(getPalette(_earthTone).Reverse().Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette ArtDecoTone(int number) => new(getPalette(_artDecoTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette ArtDecoToneReverse(int number) => new(getPalette(_artDecoTone).Reverse().Take(number));
        /// <summary>
        /// Description: 15 colors
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette GorgeousTone(int number) => new(getPalette(_gorgeousTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette GorgeousToneReverse(int number) => new(getPalette(_gorgeousTone).Reverse().Take(number));
        /// <summary>
        /// Description: 15 colors
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette CoolTone(int number) => new(getPalette(_coolTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette CoolToneRevers(int number) => new(getPalette(_coolTone).Reverse().Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette BeachTone(int number) => new(getPalette(_beachTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette BeachToneReverse(int number) => new(getPalette(_beachTone).Reverse().Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette PurpleTone(int number) => new(getPalette(_purpleTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette PurpleToneReverse(int number) => new(getPalette(_purpleTone).Reverse().Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette WarmTone(int number) => new(getPalette(_warmTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette WarmToneReverse(int number) => new(getPalette(_warmTone).Reverse().Take(number));
        /// <summary>
        /// Description: 15 colors
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette ElegantTone(int number) => new(getPalette(_elegantTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette ElegantToneReverse(int number) => new(getPalette(_elegantTone).Reverse().Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette GreenTone(int number) => new(getPalette(_greenTone).Take(number));
        ...
        /// <param name="number"></param>
        /// <returns></returns>
        public static OxyPalette GreenToneReverse(int number) => new(getPalette(_greenTone).Reverse().Take(number));
