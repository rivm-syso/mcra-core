...
namespace MCRA.Utils.Collections {
    /// <summary>
    /// TwoKeyDictionary: Dictionary with composite key consisting of 2 values
    /// </summary>
    ...
    public class TwoKeyDictionary<TKey1, TKey2, TValue> : IEnumerable<KeyValuePair<(TKey1, TKey2), TValue>> {

        private readonly Dictionary<(TKey1, TKey2), TValue> _dict = new();
