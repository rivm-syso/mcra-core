...
namespace MCRA.Utils.Collections {
    ...
    public class ThreeKeyConcurrentDictionary<TKey1, TKey2, TKey3, TValue> : IEnumerable<KeyValuePair<(TKey1, TKey2, TKey3), TValue>> {

        private readonly ConcurrentDictionary<(TKey1, TKey2, TKey3), TValue> _dict = new();
        ...
        /// </summary>
        public ThreeKeyConcurrentDictionary() {
        }
        ...
        public TValue AddOrUpdate(TKey1 key1, TKey2 key2, TKey3 key3, Func<TKey1, TKey2, TKey3, TValue> addValueFactory, Func<TKey1, TKey2, TKey3, TValue, TValue> updateValueFactory) {
            var addFactory = new Func<(TKey1, TKey2, TKey3), TValue>(t => addValueFactory(t.Item1, t.Item2, t.Item3));
            var updateFactory = new Func<(TKey1, TKey2, TKey3), TValue, TValue>((t, v) => updateValueFactory(t.Item1, t.Item2, t.Item3, v));
            return _dict.AddOrUpdate((key1, key2, key3), addFactory, updateFactory);
        }
        ...
        /// <returns>The new value for the key. This will be either be the result of addValueFactory
        /// (if the key was absent) or the result of updateValueFactory (if the key was present).</returns>
        public TValue AddOrUpdate(TKey1 key1, TKey2 key2, TKey3 key3, TValue addValue, Func<TKey1, TKey2, TKey3, TValue, TValue> updateValueFactory) {
            var updateFactory = new Func<(TKey1, TKey2, TKey3), TValue, TValue>((t, v) => updateValueFactory(t.Item1, t.Item2, t.Item3, v));
            return _dict.AddOrUpdate((key1, key2, key3), addValue, updateFactory);
        }
        ...
        public TValue GetOrAdd(TKey1 key1, TKey2 key2, TKey3 key3, Func<TKey1, TKey2, TKey3, TValue> valueFactory) {
            var vFactory = new Func<(TKey1, TKey2, TKey3), TValue>(t => valueFactory(t.Item1, t.Item2, t.Item3));
            return _dict.GetOrAdd((key1, key2, key3), vFactory);
        }
        ...
        /// <returns></returns>
        public TValue GetOrAdd(TKey1 key1, TKey2 key2, TKey3 key3, TValue value) {
            return _dict.GetOrAdd((key1, key2, key3), value);
        ...
        public bool TryAdd(TKey1 key1, TKey2 key2, TKey3 key3, TValue value) {
            return _dict.TryAdd((key1, key2, key3), value);
        }
        ...
        public bool TryRemove(TKey1 key1, TKey2 key2, TKey3 key3, out TValue value) {
            return _dict.TryRemove((key1, key2, key3), out value);
        }
        ...
        public bool TryUpdate(TKey1 key1, TKey2 key2, TKey3 key3, TValue newValue, TValue comparisonValue) {
            return _dict.TryUpdate((key1, key2, key3), newValue, comparisonValue);
        }
